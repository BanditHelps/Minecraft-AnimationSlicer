...
SKIN_UV_MAPPING = {
    ...
    'head_left': (0, 8, 8, 16),        # Left side of head
    'head_right': (16, 8, 24, 16),     # Right side of head
    ...
    # === LEFT ARM ===
    'left_arm_front': (44, 20, 48, 32),      # Left arm front
    'left_arm_back': (52, 20, 56, 32),       # Left arm back
    'left_arm_top': (44, 16, 48, 20),        # Left arm top
    'left_arm_bottom': (48, 16, 52, 20),     # Left arm bottom
    'left_arm_left': (40, 20, 44, 32),       # Left arm left side
    'left_arm_right': (48, 20, 52, 32),      # Left arm right side
    
    # === RIGHT ARM ===
    'right_arm_front': (36, 52, 40, 64),     # Right arm front
    'right_arm_back': (44, 52, 48, 64),      # Right arm back
    'right_arm_top': (36, 48, 40, 52),       # Right arm top
    'right_arm_bottom': (40, 48, 44, 52),    # Right arm bottom
    'right_arm_left': (32, 52, 36, 64),      # Right arm left side
    'right_arm_right': (40, 52, 44, 64),     # Right arm right side
    ...
    'left_leg_left': (0, 20, 4, 32),         # Left leg left side
    'left_leg_right': (8, 20, 12, 32),       # Left leg right side
    ...
    'right_leg_left': (16, 52, 20, 64),      # Right leg left side
    'right_leg_right': (24, 52, 28, 64),     # Right leg right side
}
